...
const TRANSLATIONS = {
  id: {
    ...
    media_subject_hint: "Contoh: Matematika, IPA, Desain Grafis",
    media_subject_placeholder: "Ketik mata pelajaran atau pilih dari modul ajar",
    media_material_hint: "Topik & rincian konsep utama",
    media_material_placeholder: "Tuliskan topik, materi pokok, atau konsep kunci yang ingin dijelaskan pada slide presentasi...",
    media_grade_full_label: "Kelas / Jenjang Pendidikan",
    media_grade_hint: "Contoh: Kelas 7 SMP / Fase D, Kelas 10 SMA",
    media_grade_placeholder: "Ketik kelas / jenjang atau pilih dari modul ajar",
    media_slide_count_hint: "Pilih rekomendasi AI atau tentukan sendiri",
    media_btn_ai_recommend: "Rekomendasi AI",
    media_btn_fill_own: "Isi Sendiri",
    media_slide_custom_placeholder: "Masukkan angka jumlah slide (misal: 6, 8, 12)",
    media_hint_module_loading: "Memuat modul...",
    media_note_footer: "Menggunakan Kunci Google Gemini AI akun Anda \u2022 Lanjut ke Sesi 2 untuk mereview dan mengedit outline slide",
    media_card2_title: "2. Outline Slide Presentasi",
    media_card2_subtitle: "Sesuaikan judul, ide materi, atau geser (drag) urutan slide sebelum membuat media visual",
    media_btn_add_slide: "Tambah Slide",
    media_loading_outline_title: "AI Sedang Menyusun Outline...",
    media_loading_outline_sub: "Menghubungkan ke Google Gemini AI...",
    media_btn_add_slide_bottom: "Tambah Slide Baru ke Outline",
    media_btn_back_to_info: "Kembali ke Informasi Materi",
    media_btn_generate_media: "Generate Media Pembelajaran",
    media_card3_title: "3. Hasil Media Pembelajaran",
    media_card3_subtitle: "Media presentasi PowerPoint bergambar siap digunakan di kelas",
    media_btn_copy_text: "Salin Teks",
    media_loading_media_title: "Sedang Membuat Media PPT Bergambar...",
    media_loading_media_sub: "Menghasilkan visual gambar edukatif beresolusi tinggi untuk setiap slide...",
    media_slide_ready_badge: "Slide Bergambar Siap",
    media_btn_download_pptx_full: "Unduh File PowerPoint Bergambar (.pptx)",
    media_btn_back_outline: "Kembali Edit Outline Slide",
    media_btn_new_presentation: "Buat Presentasi Baru",
    media_img_bar_label: "Format 16:9 HD Gambar Slide",
    media_btn_download_img: "Unduh Gambar (PNG)",
  ...
  en: {
    ...
    media_subject_hint: "Example: Mathematics, Science, Graphic Design",
    media_subject_placeholder: "Type subject or select from teaching module",
    media_material_hint: "Topic & core concept details",
    media_material_placeholder: "Describe the topic, core material, or key concepts to present on the slides...",
    media_grade_full_label: "Grade / Education Level",
    media_grade_hint: "Example: Grade 7 / Phase D, Grade 10 High School",
    media_grade_placeholder: "Type grade / level or select from teaching module",
    media_slide_count_hint: "Choose AI recommendation or set manually",
    media_btn_ai_recommend: "AI Recommendation",
    media_btn_fill_own: "Set Manually",
    media_slide_custom_placeholder: "Enter number of slides (e.g.: 6, 8, 12)",
    media_hint_module_loading: "Loading modules...",
    media_note_footer: "Using your Google Gemini AI Key \u2022 Continue to Session 2 to review and edit the slide outline",
    media_card2_title: "2. Slide Presentation Outline",
    media_card2_subtitle: "Adjust titles, content ideas, or drag to reorder slides before generating visual media",
    media_btn_add_slide: "Add Slide",
    media_loading_outline_title: "AI Is Composing Outline...",
    media_loading_outline_sub: "Connecting to Google Gemini AI...",
    media_btn_add_slide_bottom: "Add New Slide to Outline",
    media_btn_back_to_info: "Back to Material Info",
    media_btn_generate_media: "Generate Learning Media",
    media_card3_title: "3. Learning Media Output",
    media_card3_subtitle: "Illustrated PowerPoint presentation media ready for classroom use",
    media_btn_copy_text: "Copy Text",
    media_loading_media_title: "Generating Illustrated PPT Media...",
    media_loading_media_sub: "Generating high-resolution educational visuals for each slide...",
    media_slide_ready_badge: "Illustrated Slides Ready",
    media_btn_download_pptx_full: "Download Illustrated PowerPoint File (.pptx)",
    media_btn_back_outline: "Back to Edit Slide Outline",
    media_btn_new_presentation: "New Presentation",
    media_img_bar_label: "16:9 HD Slide Image",
    media_btn_download_img: "Download Image (PNG)",
...
const PHRASE_PAIRS = [
  ...
  ['Kelas / Jenjang Pendidikan', 'Grade / Education Level'],
  ['Topik & rincian konsep utama', 'Topic & core concept details'],
  ['Pilih rekomendasi AI atau tentukan sendiri', 'Choose AI recommendation or set manually'],
  ['Rekomendasi AI', 'AI Recommendation'],
  ['Isi Sendiri', 'Set Manually'],
  ['Tambah Slide', 'Add Slide'],
  ['AI Sedang Menyusun Outline...', 'AI Is Composing Outline...'],
  ['Menghubungkan ke Google Gemini AI...', 'Connecting to Google Gemini AI...'],
  ['Tambah Slide Baru ke Outline', 'Add New Slide to Outline'],
  ['Kembali ke Informasi Materi', 'Back to Material Info'],
  ['2. Outline Slide Presentasi', '2. Slide Presentation Outline'],
  ['Sesuaikan judul, ide materi, atau geser (drag) urutan slide sebelum membuat media visual', 'Adjust titles, content ideas, or drag to reorder slides before generating visual media'],
  ['3. Hasil Media Pembelajaran', '3. Learning Media Output'],
  ['Media presentasi PowerPoint bergambar siap digunakan di kelas', 'Illustrated PowerPoint presentation media ready for classroom use'],
  ['Salin Teks', 'Copy Text'],
  ['Sedang Membuat Media PPT Bergambar...', 'Generating Illustrated PPT Media...'],
  ['Menghasilkan visual gambar edukatif beresolusi tinggi untuk setiap slide...', 'Generating high-resolution educational visuals for each slide...'],
  ['Slide Bergambar Siap', 'Illustrated Slides Ready'],
  ['Unduh File PowerPoint Bergambar (.pptx)', 'Download Illustrated PowerPoint File (.pptx)'],
  ['Kembali Edit Outline Slide', 'Back to Edit Slide Outline'],
  ['Buat Presentasi Baru', 'New Presentation'],
  ['Format 16:9 HD Gambar Slide', '16:9 HD Slide Image'],
  ['Unduh Gambar (PNG)', 'Download Image (PNG)'],
...
const PLACEHOLDER_PAIRS = [
  ['Ketik mata pelajaran atau pilih dari modul ajar', 'Type subject or select from teaching module'],
  ['Tuliskan topik, materi pokok, atau konsep kunci yang ingin dijelaskan pada slide presentasi...', 'Describe the topic, core material, or key concepts to present on the slides...'],
  ['Ketik kelas / jenjang atau pilih dari modul ajar', 'Type grade / level or select from teaching module'],
  ['Masukkan angka jumlah slide (misal: 6, 8, 12)', 'Enter number of slides (e.g.: 6, 8, 12)'],
